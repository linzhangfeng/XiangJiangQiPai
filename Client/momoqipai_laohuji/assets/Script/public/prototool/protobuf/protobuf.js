    ...
    ProtoBuf.Builder = (function(ProtoBuf, Lang, Reflect) {
        ...
        BuilderPrototype["import"] = function(json, filename) {
            ...
            if (json['imports'] && json['imports'].length > 0) {
                ...
                ProtoBuf.Util.fetch = cc.loader.getProtoRes.bind(cc.loader);
                ...
                for (var i=0; i<json['imports'].length; i++) {
                    if (typeof json['imports'][i] === 'string') { // Import file
                        ...
                        if (!contents){
                            contents = ProtoBuf.Util.fetch(filename);
                        }
                        if (-1!=importFilename.indexOf('loginproto.proto'))importFilename = 'proto/loginproto.proto';
                        else if (-1!=importFilename.indexOf('guizhougameproto.proto'))importFilename = 'proto/guizhougameproto.proto';
                        else if (-1!=importFilename.indexOf('hunangameproto.proto'))importFilename = 'proto/hunangameproto.proto';
                        else if (-1!=importFilename.indexOf('yuanjianggameproto.proto'))importFilename = 'proto/yuanjianggameproto.proto';
                        else if (-1!=importFilename.indexOf('gameproto.proto'))importFilename = 'proto/gameproto.proto';
