module.exports = cc.Class({
    ...
    init(rootNode) {
        ...
        GUtils.addBtnClick(this.bt_ready, function (event) {
            GTcp.sendReady(cc.csd.Model.seatid, true);
        });
