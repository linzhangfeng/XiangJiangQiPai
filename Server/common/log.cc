...
void CLog::start(string log_file, int level, int console, int rotate,
...
void CLog::output(char *buf, int cnt) {
...
void CLog::panic(const char *fmt, ...) {
